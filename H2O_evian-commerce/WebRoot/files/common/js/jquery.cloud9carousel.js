  ...
  var Carousel = function( element, options ) {
    ...
    this.bindControls = function() {
      options.buttonLeft.bind( 'click', function() {
        ...
        $('.card').parent().parent().find('.button').addClass('no-active');
        return false;
      } );
      ...
      if( options.bringToFront ) {
        $container.bind( 'click.cloud9', function( event ) {
          ...
          var goLink = options.goLink;
          var controlButton = $(options.controlButton);

          if( hits.length !== 0 ) {
            var z100 = hits.css("z-index");
            ...
            if(z100 == 100 && goLink == 1){
              hits.toggleClass('active');
              controlButton.toggleClass('no-active');
            }else if(z100 == 100 && goLink == 2){
                hits.toggleClass('active');
                controlButton.toggleClass('no-active');
            }else{
                hits.siblings('.card').removeClass('active');
                controlButton.addClass('no-active');
            }
