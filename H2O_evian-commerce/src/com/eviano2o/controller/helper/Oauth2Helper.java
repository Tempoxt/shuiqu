...
public class Oauth2Helper extends BaseControllerHelper {
	...
	public void Init() {
		...
		if(styleCode==null){
			_request.getSession().setAttribute("themeColor",1);
		}else{
			_request.getSession().setAttribute("themeColor",styleCode);
		}
		...
		}else if(state.equals("imaCode")){
			_result = "redirect:/weixin/imaCode";
		}else{
